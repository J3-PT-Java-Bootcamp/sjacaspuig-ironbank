...
public class KeycloakService {
    ...
    public Object[] createUser(UserKeycloak user){
    ...
    private RealmResource getRealmResource(){
        Keycloak kc = KeycloakBuilder.builder().serverUrl(server_url).realm("master").username("sjacaspuig")
                .password("sjacaspuig28").clientId("admin-cli").resteasyClient(new ResteasyClientBuilder().connectionPoolSize(10).build())
                .build();
